...
select owners.full_name as OwnsMostAnimals, COUNT(animals.name) as total_animals from owners join animals on animals.owner_id=owners.id group by owners.full_